...
class A2C():
    def __init__(self, env):
        ...
        self.lambdaValue = 0.975 # For calculating GAE
        ...
        for episode in range(self.totalNumEpisodes):
            ...
            while not terminated and not truncated:
                ...
                if terminated == True or truncated == True or steps > max_steps:
                    ...
                    if episode % 10 == 0:                    
                        print("episode: {}, reward: {}, average reward: {}".format(episode, (np.sum(rewards)/1.5), (self.averageRewards[-1]/1.5)))
                    break
