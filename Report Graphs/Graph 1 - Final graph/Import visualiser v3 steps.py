...
plt.plot(rolling_avg_green.index, rolling_avg_green, label='PPO', color='green')
...
plt.plot(rolling_avg_blue.index, rolling_avg_blue, label='REINFORCE', color='blue')
...
plt.plot(rolling_avg_gold.index, rolling_avg_gold, label='A2C', color='purple')
