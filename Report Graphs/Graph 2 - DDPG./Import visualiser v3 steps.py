...
plt.plot(rolling_avg_green.index, rolling_avg_green, label='DDPG (27-64-64-32-32)', color='green')
...
plt.plot(rolling_avg_blue.index, rolling_avg_blue, label='DDPG (27-128-32-32)', color='blue')
...
#plt.plot(rolling_avg_gold.index, rolling_avg_gold, label='DDPG (27-128-32-32) /w simulated annealing', color='purple')
...
plt.axhline(rolling_avg_gold.loc[peak_index_gold], color='red', linestyle='--', linewidth=2)
